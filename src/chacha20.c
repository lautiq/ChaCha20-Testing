...
static void chacha20_init_block(struct chacha20_context *ctx, const uint8_t key[], const uint8_t nonce[])
{
...
void chacha20_init_context(struct chacha20_context *ctx, const uint8_t key[], const uint8_t nonce[],
