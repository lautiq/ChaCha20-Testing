...
static const uint8_t test_key[32] = {
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; ///< Ejemplo de clave para pruebas.

static const uint8_t test_nonce[12] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; ///< Ejemplo de nonce para pruebas.
...
static uint8_t plaintext[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}; ///< Ejemplo de texto plano para
                                                                 ///< pruebas.
...
static const uint8_t expected_ciphertext[] = {
    ...
    0xed, 0x1a, 0xa8, 0x36, 0xef, 0xcc, 0x8b, 0x77, 0x0d, 0xc7}; ///< Salida cifrada esperada para
                                                                 ///< pruebas.
...
void test_chacha20_encrypt_with_different_nonces(void) {
    ...
    uint8_t new_nonce[12] = {0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
                             0x01, 0x01, 0x01, 0x01, 0x01, 0x01}; // Nuevo nonce para pruebas
